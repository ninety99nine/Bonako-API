...
class OrderPaymentStatus implements CastsAttributes
{
    use BaseTrait;
    ...
    public function get($model, $key, $value, $attributes)
    {
        ...
        switch ($key) {
            case  $model->isPaid($value):
                ...
                break;
            case $model->isUnpaid($value):
                $description = 'This '.$descriptionName.' has not been paid';
                break;
            case $model->isPartiallyPaid($value):
                $description = 'This '.$descriptionName.' is partially paid';
                break;
