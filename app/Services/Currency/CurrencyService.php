...
class CurrencyService
{
    ...
    /**
     * Find currency matching given the currency code.
     *
     * @param string $code - "USD" for the United States currency.
     * @return array|null
     */
    public static function findCurrencyByCode(string $code): array|null
    {
        return collect(self::getCurrencies())->firstWhere('code', $code);
    }
}
