 ...
 *  assumes that we first need to target the default store,
 *  then the orders of that store, then we perform the
 ...
 *      });
 *
 *  (3) ...?filters={"defaultStore.orders.amount" : { "whereNotBetween" : "50,100" }}
 *
 *      $query->whereHas('defaultStore.orders', function (Builder $query) {
 *          //  Do the query stuff here
 *      });
 *
...
class RepositoryFilter
{
    ...
    private function setFilterOperations(){
         ...
         *      or "defaultStore.orders.amount", with each word
         ...
         *  "defaultStore.orders.amount"     to      ["defaultStore", "orders", "amount"]
         *
    ...
    public function apply($model) {
         ...
         *      [
         *
         *          'nestedRelationships' => 'defaultStore.orders',
         *          'columnName' => 'amount',
         *          'operator' => '>',
         *          'value' => '10.00',
         *      ],
